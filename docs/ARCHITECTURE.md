...
Back-end requires Java 21+ and runs on Tomcat 10.1+ using Jakarta Servlet 6.0. It uses PostgreSQL database.

REST APIs use Jersey 3 and Jakarta REST, dependency injection uses Guice 7, and API documentation uses OpenAPI 3. See [README.md](../README.md) for build and deployment instructions.
...
| rest/json | DTO JSON |
| rest/...Resource.java | REST API based on jakarta.ws.rs |
