...
document.localization['fr_FR'] = {
    ...
    'form.configuration.settings.mdm.extras': 'Paramètres d\'administration supplémentaires',
    'form.configuration.settings.mdm.extras.placeholder': 'Paramètres MDM supplémentaires séparés par des virgules, par exemple:\n"com.hmdm.OPEN_WIFI": true',
    'form.configuration.settings.mdm.permissive.locked': 'Désactivez le mode kiosque pour activer le mode permissif',
    ...
    'form.application.setting.variables.hint': 'Les chaînes %NUMBER%, %IMEI%, %PHONE%, %DESCRIPTION%, %CUSTOM1%, %CUSTOM2%, %CUSTOM3% seront remplacées par leurs valeurs',
    ...
    'form.application.generic.name': 'Les noms génériques ne sont pas recommandés. Utilisez {name}-{version}.apk',
