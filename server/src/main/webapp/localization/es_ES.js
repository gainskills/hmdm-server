...
document.localization['es_ES'] = {
    ...
    'error.application.version.deletion.prohibited': 'La version es unica o bien esta siendo usada en configuraciónes y no puede eliminarse',
    ...
    'form.configuration.settings.mdm.extras.placeholder': 'Configuración MDM adicional separada por comas, p. ej.:\n"com.hmdm.OPEN_WIFI": true',
    'form.configuration.settings.mdm.permissive.locked': 'Desactivar el modo quiosco para habilitar la opción de modo permisivo',
    ...
    'form.application.setting.variables.hint': 'Las cadenas %NUMBER%, %IMEI%, %PHONE%, %DESCRIPTION%, %CUSTOM1%, %CUSTOM2%, %CUSTOM3% se reemplazarán por sus valores',
    ...
    'form.application.generic.name': 'No se recomienda usar nombres genéricos. Utilice {name}-{version}.apk',
