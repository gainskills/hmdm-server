...
document.localization['en_US'] = {
    ...
    'form.application.setting.variables.hint': 'Strings %NUMBER%, %IMEI%, %PHONE%, %DESCRIPTION%, %CUSTOM1%, %CUSTOM2%, %CUSTOM3% will be replaced by their values',
    ...
    'form.application.generic.name': 'Generic names are not recommended. Use {name}-{version}.apk',
