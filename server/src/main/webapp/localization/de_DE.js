...
document.localization['de_DE'] = {
    ...
    'form.configuration.settings.mdm.extras.placeholder': 'Komma-getrennte zusätzliche MDM-Einstellungen, z. B.: "com.hmdm.OPEN_WIFI": true',
    'form.configuration.settings.mdm.permissive.locked': 'Deaktiviert den Kioskmodus, um den permissiven Modus zu aktivieren',
    ...
    'form.application.setting.variables.hint': 'Die Zeichenfolgen %NUMBER%, %IMEI%, %PHONE%, %DESCRIPTION%, %CUSTOM1%, %CUSTOM2%, %CUSTOM3% werden durch ihre Werte ersetzt',
    ...
    'form.application.generic.name': 'Generische Namen werden nicht empfohlen. Verwenden Sie {name}-{version}.apk',
