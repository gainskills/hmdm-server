...
document.localization['it_IT'] = {
	...
	'form.configuration.settings.mdm.extras': 'Extra di amministrazione',
	'form.configuration.settings.mdm.extras.placeholder': 'Impostazioni MDM aggiuntive separate da virgole, ad esempio:\n"com.hmdm.OPEN_WIFI": true',
	'form.configuration.settings.mdm.permissive.locked': 'Disattiva la modalità chiosco per abilitare l\'opzione modalità permissiva',
	...
	'form.application.setting.variables.hint': 'Le stringhe %NUMBER%, %IMEI%, %PHONE%, %DESCRIPTION%, %CUSTOM1%, %CUSTOM2%, %CUSTOM3% saranno sostituite dai rispettivi valori',
	...
	'form.configuration.file.override.path': 'Sovrascrivi il percorso',
	'form.configuration.file.override.path.title': 'Specifica il percorso del dispositivo solo per questa configurazione',
	...
	'form.application.generic.name': 'I nomi generici non sono consigliati. Utilizzare {name}-{version}.apk',
