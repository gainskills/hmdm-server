...
document.localization['ru_RU'] = {
    ...
    'form.configuration.settings.mdm.kiosk.screen': 'Экран всегда включен',
    ...
    'form.configuration.settings.mdm.launcher': 'Особый URL лаунчера',
    'form.configuration.settings.mdm.launcher.placeholder': 'Переопределить URL лаунчера для регистрации устройств в закрытых сетях',
    ...
    'form.configuration.settings.mdm.extras': 'Дополнительные параметры',
    'form.configuration.settings.mdm.extras.placeholder': 'Дополнительные параметры MDM, разделенные запятыми, например:\n"com.hmdm.OPEN_WIFI": true',
    'form.configuration.settings.mdm.permissive.locked': 'Отключите режим киоска, чтобы включить разрешительный режим',
    ...
    'form.application.setting.variables.hint': 'Строки %NUMBER%, %IMEI%, %PHONE%, %DESCRIPTION%, %CUSTOM1%, %CUSTOM2%, %CUSTOM3% будут заменены их значениями',
