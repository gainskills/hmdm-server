...
document.localization['zh_CN'] = {
    ...
    'form.configuration.settings.mdm.kiosk.screen': '屏幕常亮',
    ...
    'form.configuration.settings.mdm.launcher': '覆盖启动器 URL',
    'form.configuration.settings.mdm.launcher.placeholder': '用于在封闭网络中注册的备用启动器 URL',
    ...
    'form.configuration.settings.mdm.extras': '管理员附加设置',
    'form.configuration.settings.mdm.extras.placeholder': '以逗号分隔的额外 MDM 设置，例如：\n"com.hmdm.OPEN_WIFI": true',
    'form.configuration.settings.mdm.permissive.locked': '关闭自助服务终端模式以启用允许模式选项',
    ...
    'form.application.setting.variables.hint': '字符串%NUMBER%、%IMEI%、%PHONE%、%DESCRIPTION%、%CUSTOM1%、%CUSTOM2%、%CUSTOM3%将替换为其值',
    ...
    'form.application.generic.name': '不建议使用通用名称。请使用 {name}-{version}.apk',
    ...
    'form.settings.common.default.launcher': "后台模式",
    ...
    'table.heading.device.default.launcher': "后台模式",
