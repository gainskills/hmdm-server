...
document.localization['pt_PT'] = {
    ...
    'form.application.setting.variables.hint': 'Strings %NUMBER%, %IMEI%, %PHONE%, %DESCRIPTION%, %CUSTOM1%, %CUSTOM2%, %CUSTOM3% serão substituídos pelos seus valores',
    ...
    'form.application.generic.name': 'Nomes genéricos não são recomendados. Use {name}-{version}.apk',
