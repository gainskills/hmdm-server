...
document.localization['ja_JP'] = {
    ...
    'form.configuration.settings.mdm.extras': '管理者向け追加設定',
    'form.configuration.settings.mdm.extras.placeholder': 'カンマ区切りのMDM追加設定。例：\n"com.hmdm.OPEN_WIFI": true',
    'form.configuration.settings.mdm.permissive.locked': 'キオスクモードをオフにして、許可モードオプションを有効にします',
    ...
    'form.application.setting.variables.hint': '文字列%NUMBER%、%IMEI%、%PHONE%、%DESCRIPTION%、%CUSTOM1%、%CUSTOM2%、%CUSTOM3%はそれらの値に置き換えられます',
