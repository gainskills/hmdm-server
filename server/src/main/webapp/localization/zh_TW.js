...
document.localization['zh_TW'] = {
    ...
    'form.configuration.settings.mdm.extras': '管理員附加設定',
    'form.configuration.settings.mdm.extras.placeholder': '以逗號分隔的額外 MDM 設置，例如：\n"com.hmdm.OPEN_WIFI": true',
    'form.configuration.settings.mdm.permissive.locked': '關閉自助服務終端模式以啟用允許模式選項',
    ...
    'form.application.setting.variables.hint': '字符串%NUMBER%、%IMEI%、%PHONE%、%DESCRIPTION%、%CUSTOM1%、%CUSTOM2%、%CUSTOM3%將替換為其值',
